--Consulta 1: Listar os nomes dos pacientes que possuem consulta agendada com o profissional de registro número 2.
...
--Os índices das tabelas Paciente_Profissional, Paciente, e Profissional podem ser reaproveitados.
   CREATE INDEX idx_paciente_profissional_numregistroprof ON Paciente_Profissional (NumRegistroProf);
